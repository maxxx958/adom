...
filters_config = {
    'anonymous': [{'path': "filters/anonymous.png",
                   'anno_path': "filters/anonymous_annotations.csv",
                   'morph': True, 'animated': False, 'has_alpha': True}],
    'anime': [{'path': "filters/anime.png",
...
while True:
    ...
    if not ret:
        ...
        # Extract the Delaunay triangles for the frame
        for idx, filter in enumerate(filters):
            ...
            if filter['morph']:
                ...
                for triangle in dt:
                    pt1 = hull2[triangle[0]]
                    pt2 = hull2[triangle[1]]
                    pt3 = hull2[triangle[2]]
                    cv2.line(delaunay_frame, pt1, pt2, (255, 0, 0), 1)
                    cv2.line(delaunay_frame, pt2, pt3, (255, 0, 0), 1)
                    cv2.line(delaunay_frame, pt3, pt1, (255, 0, 0), 1)

                delaunay_frames.append(cv2.cvtColor(delaunay_frame, cv2.COLOR_BGR2RGB))
...
imageio.mimsave('output.gif', output_frames, fps=20, loop=0)
imageio.mimsave('delaunay_output.gif', delaunay_frames, fps=20, loop=0)

print("GIFs saved as 'output.gif' and 'delaunay_output.gif'")
